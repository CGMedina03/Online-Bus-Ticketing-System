        ...
        <div class="m-1 col-sm-10 col-md-7">
            <form action="/form" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="tel" class="form-control" name="mobile" id="InputNUmber" aria-describedby="contactNumber" pattern="09[0-9]{9}" placeholder="e.g. 09876543217" required />
                </div>
                <!-- input for the NUMBER OF PERSONS -->
                <div class="mb-3">
                    <label for="InputPersons" class="form-label">Number of person(s):
                    </label>
                    <input type="number" class="form-control" name="number_of_persons" id="InputPersons" aria-describedby="numberOfPersons" max='30' placeholder="e.g. 5" required />
